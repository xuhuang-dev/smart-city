			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<view class="order" v-for="(res, index) in orderList[0]" :key="res.id" @click="$u.route('/pages/zhuanti/mao/maoDetail')">
								<view class="top">
									<view class="left">
										<u-avatar size="40" src=""></u-avatar>
										<!-- <u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon> -->
										<view class="store">×××村</view>
										<!-- <u-icon name="arrow-right" color="rgb(203,203,203)" :size="26"></u-icon> -->
									</view>
									<view class="right">发布时间：2022-9-29</view>
								</view>
								<view class="item" >
									<!-- <view class="left"><image :src="res.goodsList[0].goodsUrl" mode="aspectFill"></image></view> -->
									<view class="content">
										<view class="title u-line-2">标题</view>
										<view class="type">内容内容内容内容内容内容内容内容内容内容</view>
										<view class="delivery-time">联系方式 :13788888888</view>
