			...
			<swiper class="swiper-box" :current="swiperCurrent" @transition="transition" @animationfinish="animationfinish">
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;" @scrolltolower="reachBottom">
						<view class="page-box">
							<view class="order" v-for="(res, index) in orderList[0]" :key="res.id" @click="$u.route({url:'/pages/zhuanti/made2/changshang/detail'})">
								<view class="top">
									<view class="left">
										<u-icon name="home" :size="30" color="rgb(94,94,94)"></u-icon>
										<view class="store">厂商名称</view>
										<u-icon name="arrow-right" color="rgb(203,203,203)" :size="26"></u-icon>
									</view>
									<!-- <view class="right">{{ res.deal }}</view> -->
								</view>
								<view class="item" v-for="(item, index) in [1]" :key="index">
									<view class="left"><image :src="leftImage" mode=""></image></view>
									<view class="content">
										<view class="title u-line-4">厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍厂商介绍</view>
...
export default {
	data() {
		return {
			leftImage:"../../../../static/images/image2.jpg",
			orderList: [[], [], [], []],
			dataList: [
				{
					id: 1,
